...
function _init()
	...
	screenshot_button=make_game_object("button", 117, 119, 8, 8, {
		update=function(self)
			if btnp(🅾️) then
				if cursor:check_for_hit(self) then
					extcmd("screen")
...

__sfx__
